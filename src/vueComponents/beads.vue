		...
		<div class="tabBox">
			<el-tabs v-model="activeName" @tab-click="handleClick">
				<el-tab-pane label="电脑端" name="pc">
					<section v-for="item in pcItems[0]" :key="item.func">
						<div class="ib-box">
					...
					<div class="simple-div" v-for="item in pcSimpleGet[0]" :key="item.func">
		...
		data() {
			return {
				...
				pcItems: [{
					...
					delSortItemsCache: {
						name: '分类详情页缓存',
						func: 'delSortItemsCache',
						ids: '',
						url: '/' + this.$options.name + '/app/gets/awesomeTool.php?act=delSortItemsCache&sortsId=',
						testConditions: ['类别下所有详细页面缓存清除成功'],
						processing: false,
						successMsg: "站点:"+this.$options.name+"\n类别下所有详细页面缓存清除成功\n分类ID",
						successIds: []
					} ,
				...
				mobileSimpleGet:[{
					...
					delSales_promotionCache: {
						name:"热销产品页缓存",
						func:"delSales_promotionCache",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delSales_promotionCache',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\n热销产品页缓存清理",
						processing: false,
					},
					delProduceCache: {
						name:'新品缓存',
						func:"delProduceCache",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delProduceCache',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\n最新产品页缓存清理",
						processing: false,
					},
					delSphinxNewProduct: {
						name:"sphinx新品产品缓存",
						func:"delSphinxNewProduct",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delSphinxNewProduct',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\nsphinx新品产品缓存清理",
						processing: false,
					},
					delSearch: {
						name:"搜索页缓存",
						func:"delSearch",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delSearch',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\n搜索页缓存清理",
						processing: false,
					},
					delCoupon: {
						name:"优惠券缓存",
						func:"delCoupon",
						url: '/m/'+this.$options.name+'/gets/awesomeTool.php?act=delCoupon',
						testConditions: ['permission'],
						msg: "站点:"+this.$options.name+"\n优惠券缓存清理",
						processing: false,
					},
					delSphinxNew: {
						name:"delSphinxNew",
						func:"delSphinxNew",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delSphinxNew',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\ndelSphinxNew缓存清理",
						processing: false,
					},
					delSphinxHot: {
						name:"delSphinxHot",
						func:"delSphinxHot",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delSphinxHot',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\nsphinx_hotProduct缓存清理",
						processing: false,
					},
					userTopSellPC: {
						name:"销售排行缓存",
						func:"userTopSell",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=userTopSell',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\n用户中心销售排行缓存清理",
						processing: false,
					},
					delDiyItemsCache: {
						name:"订制页面缓存",
						func:"delDiyItemsCache",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delDiyItemsCache',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\n订制化下所有详细页面缓存清理",
						processing: false,
					},
					delHotCategory: {
						name:"热销分类页缓存",
						func:"delHotCategory",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delHotCategory',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\n热销产品分类页相关缓存清理",
						processing: false,
					},
					delNewHotProduce: {
						name:'热销新品的缓存',
						func:"delNewHotProduce",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delNewHotProduce',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\n热销产品相关缓存清理",
						processing: false,
					},
					delCurrencyConverter: {
						name:"币种转换页缓存",
						func:"delCurrencyConverter",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delCurrencyConverter',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\n币种转换页面缓存清理",
						processing: false,
					},
					delBestSellers: {
						name:"bestSellers缓存",
						func:"delBestSellers",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delBestSellers',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\nbest sellers缓存清理",
						processing: false,
					},
					delDesignList: {
						name:"DesignList",
						func:"delDesignList",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delDesignList',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\ndesign_list缓存清理",
						processing: false,
					},
					delCollections: {
						name:"Collections",
						func:"delCollections",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delCollections',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\ncollections页面相关缓存清理",
						processing: false,
					},
					delFinishedJewelry: {
						name:"成品饰品页面缓存",
						func:"delFinishedJewelry",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delFinishedJewelry',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\n成品饰品页面相关缓存清理",
						processing: false,
					},
					delChristmasCache: {
						name:"圣诞页面缓存",
						func:"delChristmasCache",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delChristmasCache',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\n圣诞专题页面相关缓存清理",
						processing: false,
					},
					delSitemapCache: {
						name:"sitemap页面缓存",
						func:"delSitemapCache",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delSitemapCache',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\nsitemap页面相关缓存清理",
						processing: false,
					},
					delRenewCatalogCache: {
						name:"最新目录页缓存",
						func:"delRenewCatalogCache",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delRenewCatalogCache',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\n最新目录页缓存清理",
						processing: false,
					},
					delSphinxHotProduct: {
						name:"sphinx热销产品缓存",
						func:"delSphinxHotProduct",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delSphinxHotProduct',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\nsphinx热销产品缓存清理",
						processing: false,
					},
					delMostWish: {
						name:"收藏产品页面",
						func:"delMostWish",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delMostWish',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\n收藏产品页面清理",
						processing: false,
					},
					delVip: {
						name:"VIP介绍页面",
						func:"delVip",
						url: '/m/' + this.$options.name + '/gets/awesomeTool.php?act=delVip',
						testConditions: ['permission'],
						msg: "站点:" + this.$options.name + "\nVIP介绍页面清理",
						processing: false,
					},
				...
				mobileItems: [{
					delItemsCache: {
						...
						func: 'delItemsCache',
						ids: '',
						url: '/m/' + this.$options.name + '/app/gets/awesomeTool.php?act=delItemsCache&producesId=',
						testConditions: ['producesId','所有产品缓存删除成功'],
						processing: false,
						successMsg: "站点:"+this.$options.name+"\n产品缓存清理成功\n产品ID",
						successIds: []
					...
					delSortCache: {
						...
						func: 'delSortCache',
						ids: '',
						url: '/m/' + this.$options.name + '/app/gets/awesomeTool.php?act=delSortCache&sortsId=',
						testConditions: ['类别列表删除成功','所有头部导航删除成功'],
						processing: false,
						successMsg: "站点:"+this.$options.name+"\n分类缓存清理成功\n分类ID",
						successIds: []
					...
					delSortItemsCache: {
						...
						func: 'delSortItemsCache',
						ids: '',
						url: '/m/' + this.$options.name + '/app/gets/awesomeTool.php?act=delSortItemsCache&sortsId=',
						testConditions: ['类别下所有详细页面缓存清除成功'],
						processing: false,
						successMsg: "站点:"+this.$options.name+"\n类别下所有详细页面缓存清除成功\n分类ID",
						successIds: []
